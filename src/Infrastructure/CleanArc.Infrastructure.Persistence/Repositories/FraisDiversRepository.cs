...
namespace CleanArc.Infrastructure.Persistence.Repositories
{
    internal class FraisDiversRepository : BaseAsyncRepository<T_FRAIS_DIVERS>, IFraisDiversRepository
    {
        ...
        public async Task<List<T_FRAIS_DIVERS>> GetFraisDiversById(int id)
        {
        ...
        public async Task<bool> UpdateFraisDiversAsync( int fraisDiversId, T_FRAIS_DIVERS updatedFraisDivers)
        {
